...
>(({ index, className, ...props }, ref) => (
  <Slot
    ...
    index={index}
    className={cn(
      "relative flex h-9 w-9 items-center justify-center border border-input text-sm shadow-sm transition-all focus:z-10 group-data-[focus]:border-ring group-data-[hover]:border-accent-foreground group-data-[active]:border-accent-foreground",
      className,
    )}
    {...props}
  >
