(()=>{var e={};e.id=795,e.ids=[795],e.modules={3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},10762:e=>{"use strict";e.exports=import("@neondatabase/serverless")},10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},24467:()=>{},26418:(e,t,r)=>{"use strict";r.a(e,async(e,a)=>{try{r.d(t,{FH:()=>p,JE:()=>y,ME:()=>h,OJ:()=>m,aN:()=>E,ht:()=>g,jw:()=>x,kg:()=>c});var s=r(58617),n=r(62462),i=r(55511),l=r.n(i),o=e([n]);async function u(e){return s.Ay.hash(e,12)}async function d(e,t){return s.Ay.compare(e,t)}async function c(e,t,r){let a=await u(r),s=l().randomBytes(32).toString("hex");return(await (0,n.l)`
  ...
  `;return t?.length>0?t[0]:null}async function h(e){await (0,n.l)`DELETE FROM sessions WHERE session_token = ${e}`}async function m(e,t){await (0,n.l)`
    UPDATE users
  ...
  `}n=(o.then?(await o)():o)[0],a()}catch(e){a(e)}})},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},41565:(e,t,r)=>{"use strict";r.d(t,{d:()=>o,u:()=>l});var a=r(2824),s=r(76605),n=r(51694);a.xI.use((0,s.x)({langPrefix:"hljs language-",highlight(e,t){let r=n.A.getLanguage(t)?t:"plaintext";return n.A.highlight(e,{language:r}).value}}));let i=new a.xI.Renderer;function l(e){return a.xI.parse(e)}function o(e,t=160){let r=e.replace(/#{1,6}\s+/g,"").replace(/\*\*(.*?)\*\*/g,"$1").replace(/\*(.*?)\*/g,"$1").replace(/`(.*?)`/g,"$1").replace(/\[(.*?)\]$$.*?$$/g,"$1").replace(/!\[(.*?)\]$$.*?$$/g,"$1").replace(/^>\s+/gm,"").replace(/^\s*[-*+]\s+/gm,"").replace(/^\s*\d+\.\s+/gm,"").replace(/\n/g," ").replace(/\s+/g," ").trim();return r?.length>t?r.substring(0,t)+"...":r}i.link=(e,t,r)=>{let a=e?.startsWith("http")&&!e.includes(window?.location?.hostname||""),s=t?` title="${t}"`:"";return`<a href="${e}"${s}${a?' target="_blank" rel="noopener noreferrer"':""}>${r}</a>`},i.image=(e,t,r)=>{let a=t?` title="${t}"`:"",s=r?` alt="${r}"`:"";return`<img src="${e}"${s}${a} loading="lazy" class="rounded-lg shadow-sm" />`},i.table=(e,t)=>`<div class="overflow-x-auto my-6">
    ...
    <pre class="bg-gray-900 text-gray-100 p-4 rounded-b-lg overflow-x-auto"><code class="hljs language-${r}">${a}</code></pre>
      ...
      </div>`}}].forEach(e=>a.xI.use({extensions:[e]}))},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},49580:(e,t,r)=>{"use strict";r.a(e,async(e,a)=>{try{r.r(t),r.d(t,{DELETE:()=>d,PUT:()=>u});var s=r(28142),n=r(62462),i=r(67533),l=r(60993),o=e([n,i,l]);async function u(e,{params:t}){try{if(!await (0,l.U)(e))return s.NextResponse.json({error:"Unauthorized"},{status:401});let{title:r,content:a,cover_image:o,is_featured:u,is_pinned:d}=await e.json(),c=Number.parseInt(t.id);if(!r||!a)return s.NextResponse.json({error:"Title and content are required"},{status:400});let p=(0,i.z9)(r),g=(0,i.dn)(a),y=await (0,n.l)`SELECT id FROM posts WHERE slug = ${p} AND id != ${c}`;if(y?.length>0)return s.NextResponse.json({error:"A post with this title already exists"},{status:400});let x=await (0,n.l)`
      UPDATE posts
      SET title = ${r}, slug = ${p}, excerpt = ${g}, content = ${a},
          cover_image = ${o||null}, is_featured = ${u||!1},
          is_pinned = ${d||!1}, updated_at = CURRENT_TIMESTAMP
      WHERE id = ${c}
      RETURNING *
    `;if(x?.length===0)return s.NextResponse.json({error:"Post not found"},{status:404});return s.NextResponse.json(x[0])}catch(e){return s.NextResponse.json({error:"Failed to update post"},{status:500})}}async function d(e,{params:t}){try{if(!await (0,l.U)(e))return s.NextResponse.json({error:"Unauthorized"},{status:401});let r=Number.parseInt(t.id),a=await (0,n.l)`DELETE FROM posts WHERE id = ${r} RETURNING *`;if(a?.length===0)return s.NextResponse.json({error:"Post not found"},{status:404});return s.NextResponse.json({success:!0})}catch(e){return s.NextResponse.json({error:"Failed to delete post"},{status:500})}}[n,i,l]=o.then?(await o)():o,a()}catch(e){a(e)}})},55511:e=>{"use strict";e.exports=require("crypto")},60993:(e,t,r)=>{"use strict";r.a(e,async(e,a)=>{try{r.d(t,{H:()=>l,U:()=>i});var s=r(26418),n=e([s]);async function i(e){try{let t=e.cookies.get("session-token")?.value;if(!t)return!1;let r=await (0,s.aN)(t);return r?.is_admin===!0}catch(e){return!1}}async function l(e){try{let t=e.cookies.get("session-token")?.value;if(!t)return null;return await (0,s.aN)(t)}catch(e){return null}}s=(n.then?(await n)():n)[0],a()}catch(e){a(e)}})},61419:()=>{},62162:(e,t,r)=>{"use strict";r.a(e,async(e,a)=>{try{r.r(t),r.d(t,{patchFetch:()=>u,routeModule:()=>d,serverHooks:()=>g,workAsyncStorage:()=>c,workUnitAsyncStorage:()=>p});var s=r(43007),n=r(44360),i=r(98343),l=r(49580),o=e([l]);l=(o.then?(await o)():o)[0];let d=new s.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/admin/posts/[id]/route",pathname:"/api/admin/posts/[id]",filename:"route",bundlePath:"app/api/admin/posts/[id]/route"},resolvedPagePath:"E:\\front\\MarsLemon's-Blog\\app\\api\\admin\\posts\\[id]\\route.ts",nextConfigOutput:"",userland:l}),{workAsyncStorage:c,workUnitAsyncStorage:p,serverHooks:g}=d;function u(){return(0,i.patchFetch)({workAsyncStorage:c,workUnitAsyncStorage:p})}a()}catch(e){a(e)}})},62462:(e,t,r)=>{"use strict";r.a(e,async(e,a)=>{try{r.d(t,{l:()=>i});var s=r(10762),n=e([s]);s=(n.then?(await n)():n)[0];let i=(0,s.neon)("postgres://neondb_owner:npg_S3FPlxKdyQ6j@ep-floral-heart-adkjfqfm-pooler.c-2.us-east-1.aws.neon.tech/neondb?sslmode=require");a()}catch(e){a(e)}})},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},67533:(e,t,r)=>{"use strict";r.a(e,async(e,a)=>{try{r.d(t,{N7:()=>o,dn:()=>g,n0:()=>d,uY:()=>p,y9:()=>y,z9:()=>c,zU:()=>u,zX:()=>l});var s=r(62462),n=r(41565),i=e([s]);async function l(){return await (0,s.l)`
    SELECT * FROM posts
  ...
  `;return e?.length>0?e[0]:null}async function d(e=3){return await (0,s.l)`
    ...
    ORDER BY is_pinned DESC, created_at DESC
    LIMIT ${e}
  `}function c(e){return e.toLowerCase().replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").trim()}function p(e){return(0,n.u)(e)}function g(e,t=160){return(0,n.d)(e,t)}async function y(){try{return await (0,s.l)`SELECT * FROM posts WHERE published = true   ORDER BY created_at DESC`||[]}catch(e){return console.error("Failed to fetch posts:",e),[]}}s=(i.then?(await i)():i)[0],a()}catch(e){a(e)}})}};var t=require("../../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[535,960,659],()=>r(62162));module.exports=a})();